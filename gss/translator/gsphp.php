...
use greevex\gss\objects\Queue;
use greevex\gss\objects\Integer;
use greevex\gss\objects\String;
use greevex\gss\objects\Float;
use greevex\gss\objects\Load;
use greevex\gss\objects\Parse;
use greevex\gss\objects\SDS;

require_once '{$rootpath}/objects/_objectBase.php';
require_once '{$rootpath}/objects/Queue.php';
require_once '{$rootpath}/objects/Integer.php';
require_once '{$rootpath}/objects/String.php';
require_once '{$rootpath}/objects/Float.php';
require_once '{$rootpath}/objects/Load.php';
require_once '{$rootpath}/objects/Parse.php';
require_once '{$rootpath}/objects/SDS.php';
